...
export const LOG_ACTIONS = {
  ...
  // Surgical procedure actions
  CREATE_SURGICAL_PROCEDURE: 'CREATE_SURGICAL_PROCEDURE',
  UPDATE_SURGICAL_PROCEDURE: 'UPDATE_SURGICAL_PROCEDURE',
  DELETE_SURGICAL_PROCEDURE: 'DELETE_SURGICAL_PROCEDURE',
} as const
