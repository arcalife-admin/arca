...
export default function DashboardPage() {
  ...
  const stats: {
  ...
  }[] = [
    {
      ...
      icon: '👥',
      action: { href: '/dashboard/patients/new', label: 'Add new patient', Icon: UserPlus },
    },
    {
      name: 'Today\'s Appointments',
      value: (todayAppointments?.length || 0).toString(),
      icon: '📅',
      action: { href: '/dashboard/appointments/new', label: 'Schedule appointment', Icon: CalendarPlus },
    },
    {
      name: 'Pending Tasks',
      value: (tasks?.length || 0).toString(),
      icon: '✅',
      action: { href: '/dashboard/tasks', label: 'View tasks', Icon: ListChecks },
    },
    {
      name: 'Unread Messages',
      value: (unreadMessagesData?.unreadCount || 0).toString(),
      icon: '💬',
      action: { href: '/dashboard/chat', label: 'Open chat', Icon: MessageCircle },
    },
  ]
