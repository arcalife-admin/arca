        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="ml-4">
                <h3 className="text-sm font-medium text-gray-900 group-hover:text-green-700">Finance</h3>
                <p className="text-xs text-gray-500">Invoices, payments & reports</p>
              </div>
            </Link>
                ...
                <CollapsibleTrigger asChild>
                  <Button variant="ghost" className="w-full justify-between p-0 h-auto">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-lg font-semibold text-gray-900">Procedure Default Prices</h3>
