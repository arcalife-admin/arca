                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            copyToClipboard(patient.patientCode, 'Patient code')
                          }}
                        >
                          {patient.patientCode}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            copyToClipboard(formattedDateOfBirth, 'Date of birth')
                          }}
                        >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            copyToClipboard(patient.phone, 'Phone')
                          }}
                        >
                          {patient.phone}
                        </span>
