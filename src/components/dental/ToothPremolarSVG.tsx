...
export interface ToothPremolarSVGProps {
...
export const ToothPremolarSVG: React.FC<ToothPremolarSVGProps> = ({
  zoneStatus,
  onZoneClick,
  onZoneHover,
  hoveredZone,
  ...
  return (
    <svg viewBox={viewBox || "65 50 100 135"} className={className} style={{ ...style, zIndex: 50 }}>
      ...
      {/* Lingual square (top) */}
      <rect id="lingual" x="90" y="80" width="20" height="20" fill={getFill('lingual')} stroke="none" className={getZoneClass('lingual')} aria-label="Lingual" onClick={() => onZoneClick?.('lingual')} onMouseEnter={() => onZoneHover?.('lingual')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'lingual')} />
      {createInnerRect(90, 80, 20, 20, 'lingual')}

      {/* Buccal square (bottom) */}
      <rect id="buccal" x="90" y="120" width="20" height="20" fill={getFill('buccal')} stroke="none" className={getZoneClass('buccal')} aria-label="Buccal" onClick={() => onZoneClick?.('buccal')} onMouseEnter={() => onZoneHover?.('buccal')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'buccal')} />
      {createInnerRect(90, 120, 20, 20, 'buccal')}

      {/* Cervical zones */}
      <rect id="cervical-buccal" x="90" y="140" width="20" height="15" fill={getFill('cervical-buccal')} stroke="none" className={getZoneClass('cervical-buccal')} aria-label="Cervical Buccal" onClick={() => onZoneClick?.('cervical-buccal')} onMouseEnter={() => onZoneHover?.('cervical-buccal')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'cervical-buccal')} />
      {createInnerRect(90, 140, 20, 15, 'cervical-buccal')}

      <rect id="cervical-lingual" x="90" y="65" width="20" height="15" fill={getFill('cervical-lingual')} stroke="none" className={getZoneClass('cervical-lingual')} aria-label="Cervical Lingual" onClick={() => onZoneClick?.('cervical-lingual')} onMouseEnter={() => onZoneHover?.('cervical-lingual')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'cervical-lingual')} />
      {createInnerRect(90, 65, 20, 15, 'cervical-lingual')}
      ...
      <polygon id="interdental-distal" points="130,80 110,100 110,120 130,140" fill={getFill('interdental-distal')} stroke="none" className={getZoneClass('interdental-distal')} aria-label="Interdental Distal" onClick={() => onZoneClick?.('interdental-distal')} onMouseEnter={() => onZoneHover?.('interdental-distal')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'interdental-distal')} />
      {createInnerPolygon("130,80 110,100 110,120 130,140", 'interdental-distal')}
      ...
      <polygon id="triangle-2" points="110,65 130,80 110,100" fill={getFill('triangle-2')} stroke="none" className={getZoneClass('triangle-2')} aria-label="Triangle 2" onClick={() => onZoneClick?.('triangle-2')} onMouseEnter={() => onZoneHover?.('triangle-2')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'triangle-2')} />
      {createInnerPolygon("110,65 130,80 110,100", 'triangle-2')}
      ...
      <polygon id="triangle-4" points="110,155 130,140 110,120" fill={getFill('triangle-4')} stroke="none" className={getZoneClass('triangle-4')} aria-label="Triangle 4" onClick={() => onZoneClick?.('triangle-4')} onMouseEnter={() => onZoneHover?.('triangle-4')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'triangle-4')} />
      {createInnerPolygon("110,155 130,140 110,120", 'triangle-4')}

      {/* Occlusal square (center) */}
      <rect id="occlusal" x="92" y="102" width="16" height="16" fill={getFill('occlusal')} stroke={getStatusOutlineColor(zoneStatus['occlusal'], wholeTooth)} strokeWidth="2" strokeLinejoin="round" className={getZoneClass('occlusal')} aria-label="Occlusal" onClick={() => onZoneClick?.('occlusal')} onMouseEnter={() => onZoneHover?.('occlusal')} onMouseLeave={() => onZoneHover?.(null)} onKeyDown={e => handleKeyDown(e, 'occlusal')} />

      {/* Thick outer buccal outline */}
      <polygon points="70,80 90,65 110,65 130,80 110,100 90,100" fill="none" stroke={getStatusOutlineColor(zoneStatus['buccal-outline'], wholeTooth)} strokeWidth="0" strokeLinejoin="round" />

      {/* Thick outer lingual outline */}
      <polygon id="lingual-outline" points="70,140 90,155 110,155 130,140 110,120 90,120" fill="none" stroke={getStatusOutlineColor(zoneStatus['lingual-outline'], wholeTooth)} strokeWidth="0" strokeLinejoin="round" />
...
export default ToothPremolarSVG;