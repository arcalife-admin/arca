...
export const INLAYS_AND_CROWNS: LegacyDentalCode[] = [
  {
    code: 'R08',
...
export const BRIDGEWORK: LegacyDentalCode[] = [
  {
    code: 'R40',
...
export const VARIOUS_RESTORATIONS: LegacyDentalCode[] = [
  {
    code: 'R67',
