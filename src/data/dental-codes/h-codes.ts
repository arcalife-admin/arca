...
export const BASIC_PROCEDURES: LegacyDentalCode[] = [
  {
    code: 'H11',
...
export const COMPLEX_PROCEDURES: LegacyDentalCode[] = [
  {
    code: 'H90',
...
export const AUTOTRANSPLANTATION: LegacyDentalCode[] = [
  {
    code: 'H36',
...
export const MINOR_PROCEDURES: LegacyDentalCode[] = [
  {
    code: 'H40',
...
export const ROOT_PROCEDURES: LegacyDentalCode[] = [
  {
    code: 'H42',
...
// F. Cyst Operations
export const CYST_OPERATIONS: LegacyDentalCode[] = [
  {
    code: 'H60',
...
export const PROSTHETIC_CORRECTIONS: LegacyDentalCode[] = [
  {
    code: 'H70',
